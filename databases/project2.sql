...
(2, 'Lotus Allan', '105138731', 'Developed the index page and collaborated on CSS styling', 'Created Manager Login and Manager Dashboard', 'Quote: \"Vita revera est valde simplex, non necesse est eam tam complicatam facere.\"\n(Life is really very simple, there\'s no need to make it so complicated.) - Latin'),
...
(4, 'Krisha Upadhyay', '106513368', 'Built the Apply page and collaborated on CSS styling', 'Created confirmation page with randomised EOI number', 'Quote: \"sicut ad eam\"\n(Just do it) - Latin');
